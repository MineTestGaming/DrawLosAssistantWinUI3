...
namespace DrawLosAssistantWinUI3.ResultPage
{
    ...
    public sealed partial class Rare : Page
    {
        ...
        public Rare()
        {
            ...
            if (localSettings.Values.ContainsKey("RareVideoPath"))
            {
                GachaLoading.MediaPlayer.Source = MediaSource.CreateFromUri(new Uri(localSettings.Values["RareVideoPath"].ToString()));
            }
        }
